...
class BoxGeometry {
  ...
  private _minimum: Cartesian3
  private _maximum: Cartesian3
  private _vertexFormat: VertexFormat
  private _offsetAttribute: GeometryOffsetAttribute
  ...
  static unpack(array: number[], startingIndex: number = 0, result?: BoxGeometry) {
  ...
  static createGeometry(boxGeometry: BoxGeometry) {
